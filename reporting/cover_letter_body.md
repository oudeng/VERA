...
During the preparation of this work the authors used Anthropic Claude to assist with code development and manuscript drafting. The authors reviewed and edited all content and take full responsibility for the content of the publication. This is stated in the manuscript's declarations; a fuller account of the workflow, including the measured share of AI-assisted commits and the categories it covered, is given in the repository's README for any reader who wants it.
