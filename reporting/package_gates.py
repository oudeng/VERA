...
def gate_17_cited_scripts_run() -> dict:
    ...
    RUNNABLE = {"fair_same_host_recovery.py": "--selftest",
                ...
                #: --help, not --selftest: the scan's fixtures live in the
                #: PUBLISHED tree, which a review package does not carry.
                #: Its enforcing run is in build_public_repo, before git-init;
                #: what the package can honestly claim is that it loads.
                "evidence_dua_scan.py": "--help"}
